...
| Color scale | Violet; Sky Blue; Bluish Mauve; White tinged purple |
| Central figure | Nuith personified (vs. formless as arch of sky in Atu XX) |
...
6. **Three seven-pointed stars, all Stars of Babalon/Venus** (Nuit and
   ...
   - largest: upper-left corner, spinning counterclockwise (cosmic
     pinwheel), curled rays of spiritual light touching everything;
...
| Silver cup + streams | `( o`.` + `\| \|` | `.' o`.`/`( ~~~ )` liquid + twin `\| \|` |
| Crystals | `<>_/\_<>` | full-shore run `<>_/\_<>_/\_<>` |
| Butterflies | `}v{` | `}i{` (both valid) |
| Roses | `,o,` | `,+,` (both valid) |
| Pyramid City | (omitted) | `./\.` on horizon |
| Sea of Binah | `~.~^~` + `aw` sig | same, wider |

## Meanings

**Crowley's divinatory meaning (BoT appendix, canonical):** Hope, unexpected
help, clearness of vision, realization of possibilities, spiritual insight;
ill-dignified: error of judgment, dreaminess, disappointment.
...
dreams and what most inspires you; express the spiritual side, joy,
openness to love; trust the Universe; after testing times, move forward
with renewed hope and full self-expression.

**Reversed (esoteric-meanings):** loss of hope and faith; scepticism;
disconnection from the spiritual; something blocking inspiration; lack of
joy; a seemingly hopeless situation testing faith; the need for something
more fulfilling.

**Tower → Star transition:** from grasping at collapsing identity to
acceptance without struggle. Hatred and bitterness have burned out.
Beginner's mind; let thoughts be rather than suppressing them ("we are
imprisoned by subtlety not obviousness"); carrying the old self is carrying
a bag of the Tower's broken blocks.

## Quotes for the card page (Liber AL ch. I)
...
## Observed Harris palette (from the actual card scan)

`reference/17-star-card.jpg` (Flickr, laird_of_kiloran Thoth album). The
...
- Crystalline shore: white-violet facets; pyramids bottom-left pink-mauve
- Butterflies: amber/gold; roses: dark red
- Border: pale warm gray art deco frame, Hé + Aquarius glyphs on title bar

Truecolor hex mapping lives in `tools/star_html.py` (TRUE dict).
